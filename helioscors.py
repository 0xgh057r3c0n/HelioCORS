...
{Fore.LIGHTYELLOW_EX}              Advanced CORS Vulnerability Detection Tool
                   Developed by: 0xgh057r3c0n
{Style.RESET_ALL}

{Fore.RED}DISCLAIMER: This tool is intended for ethical hacking, legal, 
and educational purposes only. Unauthorized use is prohibited.{Style.RESET_ALL}
"""
    print(logo)
